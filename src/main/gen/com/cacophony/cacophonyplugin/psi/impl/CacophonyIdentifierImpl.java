...
public class CacophonyIdentifierImpl extends ASTWrapperPsiElement implements CacophonyIdentifier {

  public CacophonyIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public PsiElement getVarId() {
    return findNotNullChildByType(VAR_ID);
  }
