...
public class CacophonySimpleRefExprImpl extends CacophonyExprImpl implements CacophonySimpleRefExpr {

  public CacophonySimpleRefExprImpl(@NotNull ASTNode node) {
    super(node);
  }
