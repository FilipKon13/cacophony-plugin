...
public class CacophonyFunctionCallExprImpl extends CacophonyExprImpl implements CacophonyFunctionCallExpr {

  public CacophonyFunctionCallExprImpl(@NotNull ASTNode node) {
    super(node);
  }
