...
public class CacophonyUnaryMinExprImpl extends CacophonyExprImpl implements CacophonyUnaryMinExpr {

  public CacophonyUnaryMinExprImpl(@NotNull ASTNode node) {
    super(node);
  }
