...
public class CacophonySelfOpExprImpl extends CacophonyExprImpl implements CacophonySelfOpExpr {

  public CacophonySelfOpExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull CacophonyVisitor visitor) {
    visitor.visitSelfOpExpr(this);
  }
