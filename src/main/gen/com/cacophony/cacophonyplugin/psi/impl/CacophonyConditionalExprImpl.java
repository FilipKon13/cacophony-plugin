...
public class CacophonyConditionalExprImpl extends CacophonyExprImpl implements CacophonyConditionalExpr {

  public CacophonyConditionalExprImpl(@NotNull ASTNode node) {
    super(node);
  }
